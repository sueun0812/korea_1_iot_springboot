...
public class m_api {
    ...
    // 2) 무상태성: 서버는 클라이언트에 상태 저장 X, 요청은 독립적으로 처리
    ...
    //     : /products/1004 (O)
    //     : /get-products?product_id=1004 (X)

    // createProduct (동사_제품을 생성하다)
    // createdProduct (명사_생성된 제품)
    ...
    // >> 리소스 일부만 제공하면 제공되지 않은 정보는 null 또는 기본값으로 설정
    // >> 멱등성을 가짐(Idempotent)
